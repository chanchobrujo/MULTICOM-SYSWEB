<template>
	<v-app-bar app color="primary" dark dense>
		<div class="d-flex align-center">
			...
			<div
				class="font-weight-black headline shrink mt-1 secondary--text pr-5"
				contain
				min-width="100"
			>
				MULTICOM
		...
		<div
			...
			v-for="item in $global.items"
			:key="item.name"
		>
			<router-link
				:to="item.link"
				class="secondary--text pa-2 hidden-sm-and-down"
				style="text-decoration: none;"
			>
