...
axios.defaults.baseURL =
	"http://multicomapirest-env.eba-dypxmge3.us-east-2.elasticbeanstalk.com";
...
Vue.use(SimpleVueValidator, {
	...
	templates: {
		...
		minLength:
			"Como mínimo se deben ingresar {0} carácteres.",
		lengthBetween:
			"Como máximo se deben ingresar {0} carácteres.", //-----------
		in: "Debe ser {0}.",
		notIn: "No debe ser {0}.",
